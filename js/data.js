...
const DAYS = [
  /* ───────────────────────── SHANGHAI (leg 1) ───────────────────────── */
    ...
    /* ── Day 2 in-file (new plan Day 1): Jing'an + French Concession ── */
    {
      ...
      photo: "assets/photos/shanghai.webp",
      areas: {
        morning: "Jing'an area",
        afternoon: "Huaihai Road area",
        evening: "Nanjing Road area",
      },
      morning: [
      ...
      afternoon: [
        ...
        place("d2-a17", "Moromoro Store", { note: "528-530 Huaihai Middle Road." }),
        place("d2-a18", "Huaihai Center"),
      ],
      evening: [
        place("d2-e1", "The Bund promenade & night skyline", { open: "24h", note: "Best light around 7pm when the Pudong towers switch on." }),
        place("d2-e2", "Nanjing Road Pedestrian Street", { note: "Shopping street near People's Square." }),
        place("d2-e3", "White Rabbit Store"),
        place("d2-e4", "ZX Centre (Anime Mall)"),
        place("d2-e5", "innisfree"),
        place("d2-e6", "MINISO"),
        place("d2-e7", "Adidas Shanghai Nanjing East Road Megacore Branch"),
        place("d2-e8", "New World Dawan Department Store"),
      ],
      restaurants: [
        place("d2-r1", "Qing Ting Chengdu Hotpot", { note: "7th floor." }),
        place("d2-r2", "Din Tai Fung (Jing'an branch)"),
        place("d2-r3", "Day by Day Restaurant (REEL Mall)", { note: "L425, 4/F, REEL Mall." }),
        place("d2-r4", "Jiajia Baozi Stuffed With Juicy Pork"),
        place("d2-r5", "Din Tai Fung (IAPM Mall branch)"),
        place("d2-r6", "Weixiangzhai (Sesame Noodles)"),
      ...
      cafes: [
        ...
        place("d2-c2", "LCH Cafe", { note: "Coquette cafe." }),
        place("d2-c3", "Bao Master Cake (Huaihai Middle Road branch)"),
    ...
    /* ── Day 2: Tianzifang + Xintiandi ── */
    {
      ...
      morning: [
        ...
        place("d3-m4", "Wujiang Road Leisure Street", { note: "NIKO AND location." }),
        place("d3-m5", "HKRI Taikoo Hui"),
        place("d3-m6", "Moody Lenses Flagship", { note: "M07, Basement 1, HKRI Taikoo Hui." }),
      ],
      afternoon: [
  ...
  },
  {
    ...
    restaurants: [
      place("d11-r1", "Salmon Kat Namba"),
      place("d11-r2", "Tendon Tenya"),
      place("d11-r3", "Gyukatsu Motomura"),
      place("d11-r4", "Gyukatsu Tomita"),
      place("d11-r5", "Nikutareya Meat Bal Namba"),
      place("d11-r6", "Wagyu Itaden"),
      place("d11-r7", "Shabushabu New Kobe"),
      place("d11-r8", "Sukiyaki Shabushabu Daibokujyo"),
    ],
    cafes: [
      place("d11-c1", "Rikuro’s Cheesecake"),
      place("d11-c2", "Maccha House"),
      place("d11-c3", "Lazzli Cafe"),
      place("d11-c4", "Sakimoto Bakery"),
      place("d11-c5", "Sakimoto Coffee"),
      place("d11-c6", "Chaya Sizuku"),
    ],
  },
  {
    ...
    morning: [
      place("d12-m1", "Take bullet train to hiroshima "),
      place("d12-m2", "Visit the atomic bomb museum ", { open: "08:30", close: "17:00" }),
    ],
    afternoon: [
      place("d12-a1", "Take Ferry to Miyajima Island"),
      place("d12-a2", "Visit Izukushima Jinja shrine"),
    ],
    evening: [
...
const PHRASEBOOK = [
  {
    ...
    phrases: [
      ...
      { en: "What would you recommend?", local: "有什么推荐的吗？", pron: "Yǒu shénme tuījiàn de ma?" },
      { en: "This one please", local: "我要这个，谢谢", pron: "Wǒ yào zhège, xièxie" },
      { en: "How much?", local: "多少钱？", pron: "Duōshǎo qián?" },
      { en: "How much is this please?", local: "请问这个多少钱？", pron: "Qǐngwèn zhège duōshǎo qián?" },
  ...
  },
  {
    ...
    phrases: [
      ...
      { en: "What would you recommend?", local: "おすすめは何ですか？", pron: "Osusume wa nan desu ka?" },
      { en: "This one please", local: "これをお願いします", pron: "Kore o onegai shimasu" },
      { en: "How much?", local: "いくらですか？", pron: "Ikura desu ka?" },
      { en: "How much is this please?", local: "これはいくらですか？", pron: "Kore wa ikura desu ka?" },
      { en: "Where's the toilet?", local: "トイレはどこですか？", pron: "Toire wa doko desu ka?" },
      { en: "Can I pay with card?", local: "カードで払えますか？", pron: "Kādo de haraemasu ka?" },
